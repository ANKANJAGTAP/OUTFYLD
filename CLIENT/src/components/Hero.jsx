...
const Hero = () => {
  ...
  // Overlay & section scale animation (can repeat)
  useLayoutEffect(() => {
    gsap.fromTo(
      sectionRef.current,
      { scale: 1.05 },
  ...
  // Animate heading/subheading/button only once on mount
  useLayoutEffect(() => {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-20 flex flex-col justify-center items-center h-full text-center px-4 sm:px-6 lg:px-8 py-10 sm:py-0 max-w-7xl mx-auto">
        <div className="max-w-4xl mx-auto space-y-5 sm:space-y-8 md:space-y-10">
          <h1
            ref={headingRef}
            className="text-white text-3xl xs:text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold tracking-tight leading-[1.1] whitespace-nowrap"
          >
          ...
          <p
            ref={subheadingRef}
            className="text-gray-200 text-sm xs:text-base sm:text-lg md:text-xl lg:text-2xl font-medium leading-relaxed max-w-3xl mx-auto"
          >
            {subwords.map((word, i) => (
